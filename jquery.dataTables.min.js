...
(function (k) {
  ...
  function ma(a) {
    ...
    if (a) {
      ...
      !a.sEmptyTable && d && "موردی برای نمایش وجود ندارد" === b.sEmptyTable && V(a, a, "sZeroRecords", "sEmptyTable");
  ...
  u.defaults = {
    ...
    oLanguage: {
      oAria: {
        sSortAscending: ": چیدمان از اول به آخر",
        sSortDescending: ": چیدمان از آخر به اول"
      },
      oPaginate: {
        sFirst: "اول",
        sLast: "آخر",
      ...
      sSearchPlaceholder: "",
      sUrl: "",
      sZeroRecords: "نتیجه ای برای نمایش یافت نشد"
    },
